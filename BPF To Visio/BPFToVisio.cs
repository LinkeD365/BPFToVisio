...
namespace LinkeD365.BPFToVisio
{
    ...
    [ExportMetadata("Name", "BPF to Visio Builder")]
    [ExportMetadata("Description", "Tool to document your Business Process Flows in Visio")]
    ...
    public class BPFToVisioPlugin : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new BPFToVisioCtl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public BPFToVisioPlugin()
        {
